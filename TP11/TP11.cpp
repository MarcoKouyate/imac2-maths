...
double calculerTriangle (int nbIter, double l){


  unsigned seed = std::chrono::system_clock::now().time_since_epoch().count();
  std::uniform_int_distribution<int> uniformIntDistribution(0,a);
  ...
  for (int i=0 ; i < nbIter ; i++){
    ...
    nombres.push_back(min);
    nombres.push_back(max-min);
    nombres.push_back(l-max);
